...
public class ActivityA extends AppCompatActivity {
    ...
    Button startActivityB, dialog, close;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startActivityB = (Button) findViewById(R.id.btn_start_b);
        dialog = (Button)findViewById(R.id.btn_start_dialog);
        close = (Button)findViewById(R.id.btn_closeApp);

        threadCount = (TextView)findViewById(R.id.status_view);
